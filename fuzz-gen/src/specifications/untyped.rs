...
pub use super::preparser::{Arg, Parser};
...
impl AssignExpressionId<SpecEntailmentVars<ExpressionId, Arg>>
    for common::SpecEntailmentVars<(), Arg>
{
    fn assign_id(
        self,
        spec_id: SpecificationId,
    ...
    fn encode_type_check(&self, tokens: &mut TokenStream) {
        match &*self.kind {
            ...
            AssertionKind::SpecEntailment {
                ...
                let vec_of_args_with_result: Vec<_> = arg_binders
                    .args
                    .clone()
                    .into_iter()
