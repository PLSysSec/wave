...
#define Subscription_WASI_SIZE 48

#define Subscription_CLOCK_TAG 0

#define Subscription_FD_READ_TAG 1

#define Subscription_FD_WRITE_TAG 2
...
uint32_t _Z_wasi_snapshot_preview1Z_fd_fdstat_set_rightsZ_iijj(void *ctx,
                                                               uint32_t a,
                                                               uint64_t b,
                                                               uint64_t c);
