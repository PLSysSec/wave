// generated by SMACK version 2.7.0 for boogie
// via /usr/local/bin/smack Cpp/wrappers.cpp --verifier boogie --integer-encoding=bit-vector --pointer-encoding=bit-vector --debug --entry-points safe_open safe_close safe_read safe_write
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0bv64, 17544bv64));
axiom ($EXTERNS_BOTTOM == $add.ref($GLOBALS_BOTTOM, $sub.ref(0bv64, 32768bv64)));
...
function {:inline} $load.bytes.bv16(M: [ref] bv8, p: ref) returns (bv16) { (M[$add.ref(p, 1bv64)]++M[p]) }
function {:inline} $store.bytes.bv16(M: [ref] bv8, p: ref, i: bv16) returns ([ref] bv8) { M[p := i[8:0]][$add.ref(p, 1bv64) := i[16:8]] }
...
function {:inline} $load.bytes.bv24(M: [ref] bv8, p: ref) returns (bv24) { (M[$add.ref(p, 2bv64)]++(M[$add.ref(p, 1bv64)]++M[p])) }
function {:inline} $store.bytes.bv24(M: [ref] bv8, p: ref, i: bv24) returns ([ref] bv8) { M[p := i[8:0]][$add.ref(p, 1bv64) := i[16:8]][$add.ref(p, 2bv64) := i[24:16]] }
...
function {:inline} $load.bytes.bv32(M: [ref] bv8, p: ref) returns (bv32) { (M[$add.ref(p, 3bv64)]++(M[$add.ref(p, 2bv64)]++(M[$add.ref(p, 1bv64)]++M[p]))) }
function {:inline} $store.bytes.bv32(M: [ref] bv8, p: ref, i: bv32) returns ([ref] bv8) { M[p := i[8:0]][$add.ref(p, 1bv64) := i[16:8]][$add.ref(p, 2bv64) := i[24:16]][$add.ref(p, 3bv64) := i[32:24]] }
...
function {:inline} $load.bytes.bv33(M: [ref] bv8, p: ref) returns (bv33) { (M[$add.ref(p, 3bv64)]++(M[$add.ref(p, 2bv64)]++(M[$add.ref(p, 1bv64)]++M[p]))) }
function {:inline} $store.bytes.bv33(M: [ref] bv8, p: ref, i: bv33) returns ([ref] bv8) { M[p := i[8:0]][$add.ref(p, 1bv64) := i[16:8]][$add.ref(p, 2bv64) := i[24:16]][$add.ref(p, 3bv64) := i[32:24]] }
...
function {:inline} $load.bytes.bv40(M: [ref] bv8, p: ref) returns (bv40) { (M[$add.ref(p, 4bv64)]++(M[$add.ref(p, 3bv64)]++(M[$add.ref(p, 2bv64)]++(M[$add.ref(p, 1bv64)]++M[p])))) }
function {:inline} $store.bytes.bv40(M: [ref] bv8, p: ref, i: bv40) returns ([ref] bv8) { M[p := i[8:0]][$add.ref(p, 1bv64) := i[16:8]][$add.ref(p, 2bv64) := i[24:16]][$add.ref(p, 3bv64) := i[32:24]][$add.ref(p, 4bv64) := i[40:32]] }
...
function {:inline} $load.bytes.bv48(M: [ref] bv8, p: ref) returns (bv48) { (M[$add.ref(p, 5bv64)]++(M[$add.ref(p, 4bv64)]++(M[$add.ref(p, 3bv64)]++(M[$add.ref(p, 2bv64)]++(M[$add.ref(p, 1bv64)]++M[p]))))) }
function {:inline} $store.bytes.bv48(M: [ref] bv8, p: ref, i: bv48) returns ([ref] bv8) { M[p := i[8:0]][$add.ref(p, 1bv64) := i[16:8]][$add.ref(p, 2bv64) := i[24:16]][$add.ref(p, 3bv64) := i[32:24]][$add.ref(p, 4bv64) := i[40:32]][$add.ref(p, 5bv64) := i[48:40]] }
...
function {:inline} $load.bytes.bv56(M: [ref] bv8, p: ref) returns (bv56) { (M[$add.ref(p, 6bv64)]++(M[$add.ref(p, 5bv64)]++(M[$add.ref(p, 4bv64)]++(M[$add.ref(p, 3bv64)]++(M[$add.ref(p, 2bv64)]++(M[$add.ref(p, 1bv64)]++M[p])))))) }
function {:inline} $store.bytes.bv56(M: [ref] bv8, p: ref, i: bv56) returns ([ref] bv8) { M[p := i[8:0]][$add.ref(p, 1bv64) := i[16:8]][$add.ref(p, 2bv64) := i[24:16]][$add.ref(p, 3bv64) := i[32:24]][$add.ref(p, 4bv64) := i[40:32]][$add.ref(p, 5bv64) := i[48:40]][$add.ref(p, 6bv64) := i[56:48]] }
...
function {:inline} $load.bytes.bv64(M: [ref] bv8, p: ref) returns (bv64) { (M[$add.ref(p, 7bv64)]++(M[$add.ref(p, 6bv64)]++(M[$add.ref(p, 5bv64)]++(M[$add.ref(p, 4bv64)]++(M[$add.ref(p, 3bv64)]++(M[$add.ref(p, 2bv64)]++(M[$add.ref(p, 1bv64)]++M[p]))))))) }
function {:inline} $store.bytes.bv64(M: [ref] bv8, p: ref, i: bv64) returns ([ref] bv8) { M[p := i[8:0]][$add.ref(p, 1bv64) := i[16:8]][$add.ref(p, 2bv64) := i[24:16]][$add.ref(p, 3bv64) := i[32:24]][$add.ref(p, 4bv64) := i[40:32]][$add.ref(p, 5bv64) := i[48:40]][$add.ref(p, 6bv64) := i[56:48]][$add.ref(p, 7bv64) := i[64:56]] }
...
function {:inline} $load.bytes.bv80(M: [ref] bv8, p: ref) returns (bv80) { (M[$add.ref(p, 9bv64)]++(M[$add.ref(p, 8bv64)]++(M[$add.ref(p, 7bv64)]++(M[$add.ref(p, 6bv64)]++(M[$add.ref(p, 5bv64)]++(M[$add.ref(p, 4bv64)]++(M[$add.ref(p, 3bv64)]++(M[$add.ref(p, 2bv64)]++(M[$add.ref(p, 1bv64)]++M[p]))))))))) }
function {:inline} $store.bytes.bv80(M: [ref] bv8, p: ref, i: bv80) returns ([ref] bv8) { M[p := i[8:0]][$add.ref(p, 1bv64) := i[16:8]][$add.ref(p, 2bv64) := i[24:16]][$add.ref(p, 3bv64) := i[32:24]][$add.ref(p, 4bv64) := i[40:32]][$add.ref(p, 5bv64) := i[48:40]][$add.ref(p, 6bv64) := i[56:48]][$add.ref(p, 7bv64) := i[64:56]][$add.ref(p, 8bv64) := i[72:64]][$add.ref(p, 9bv64) := i[80:72]] }
...
function {:inline} $load.bytes.bv88(M: [ref] bv8, p: ref) returns (bv88) { (M[$add.ref(p, 10bv64)]++(M[$add.ref(p, 9bv64)]++(M[$add.ref(p, 8bv64)]++(M[$add.ref(p, 7bv64)]++(M[$add.ref(p, 6bv64)]++(M[$add.ref(p, 5bv64)]++(M[$add.ref(p, 4bv64)]++(M[$add.ref(p, 3bv64)]++(M[$add.ref(p, 2bv64)]++(M[$add.ref(p, 1bv64)]++M[p])))))))))) }
function {:inline} $store.bytes.bv88(M: [ref] bv8, p: ref, i: bv88) returns ([ref] bv8) { M[p := i[8:0]][$add.ref(p, 1bv64) := i[16:8]][$add.ref(p, 2bv64) := i[24:16]][$add.ref(p, 3bv64) := i[32:24]][$add.ref(p, 4bv64) := i[40:32]][$add.ref(p, 5bv64) := i[48:40]][$add.ref(p, 6bv64) := i[56:48]][$add.ref(p, 7bv64) := i[64:56]][$add.ref(p, 8bv64) := i[72:64]][$add.ref(p, 9bv64) := i[80:72]][$add.ref(p, 10bv64) := i[88:80]] }
...
function {:inline} $load.bytes.bv96(M: [ref] bv8, p: ref) returns (bv96) { (M[$add.ref(p, 11bv64)]++(M[$add.ref(p, 10bv64)]++(M[$add.ref(p, 9bv64)]++(M[$add.ref(p, 8bv64)]++(M[$add.ref(p, 7bv64)]++(M[$add.ref(p, 6bv64)]++(M[$add.ref(p, 5bv64)]++(M[$add.ref(p, 4bv64)]++(M[$add.ref(p, 3bv64)]++(M[$add.ref(p, 2bv64)]++(M[$add.ref(p, 1bv64)]++M[p]))))))))))) }
function {:inline} $store.bytes.bv96(M: [ref] bv8, p: ref, i: bv96) returns ([ref] bv8) { M[p := i[8:0]][$add.ref(p, 1bv64) := i[16:8]][$add.ref(p, 2bv64) := i[24:16]][$add.ref(p, 3bv64) := i[32:24]][$add.ref(p, 4bv64) := i[40:32]][$add.ref(p, 5bv64) := i[48:40]][$add.ref(p, 6bv64) := i[56:48]][$add.ref(p, 7bv64) := i[64:56]][$add.ref(p, 8bv64) := i[72:64]][$add.ref(p, 9bv64) := i[80:72]][$add.ref(p, 10bv64) := i[88:80]][$add.ref(p, 11bv64) := i[96:88]] }
...
function {:inline} $load.bytes.bv128(M: [ref] bv8, p: ref) returns (bv128) { (M[$add.ref(p, 15bv64)]++(M[$add.ref(p, 14bv64)]++(M[$add.ref(p, 13bv64)]++(M[$add.ref(p, 12bv64)]++(M[$add.ref(p, 11bv64)]++(M[$add.ref(p, 10bv64)]++(M[$add.ref(p, 9bv64)]++(M[$add.ref(p, 8bv64)]++(M[$add.ref(p, 7bv64)]++(M[$add.ref(p, 6bv64)]++(M[$add.ref(p, 5bv64)]++(M[$add.ref(p, 4bv64)]++(M[$add.ref(p, 3bv64)]++(M[$add.ref(p, 2bv64)]++(M[$add.ref(p, 1bv64)]++M[p]))))))))))))))) }
function {:inline} $store.bytes.bv128(M: [ref] bv8, p: ref, i: bv128) returns ([ref] bv8) { M[p := i[8:0]][$add.ref(p, 1bv64) := i[16:8]][$add.ref(p, 2bv64) := i[24:16]][$add.ref(p, 3bv64) := i[32:24]][$add.ref(p, 4bv64) := i[40:32]][$add.ref(p, 5bv64) := i[48:40]][$add.ref(p, 6bv64) := i[56:48]][$add.ref(p, 7bv64) := i[64:56]][$add.ref(p, 8bv64) := i[72:64]][$add.ref(p, 9bv64) := i[80:72]][$add.ref(p, 10bv64) := i[88:80]][$add.ref(p, 11bv64) := i[96:88]][$add.ref(p, 12bv64) := i[104:96]][$add.ref(p, 13bv64) := i[112:104]][$add.ref(p, 14bv64) := i[120:112]][$add.ref(p, 15bv64) := i[128:120]] }
...
function {:inline} $load.bytes.bv160(M: [ref] bv8, p: ref) returns (bv160) { (M[$add.ref(p, 19bv64)]++(M[$add.ref(p, 18bv64)]++(M[$add.ref(p, 17bv64)]++(M[$add.ref(p, 16bv64)]++(M[$add.ref(p, 15bv64)]++(M[$add.ref(p, 14bv64)]++(M[$add.ref(p, 13bv64)]++(M[$add.ref(p, 12bv64)]++(M[$add.ref(p, 11bv64)]++(M[$add.ref(p, 10bv64)]++(M[$add.ref(p, 9bv64)]++(M[$add.ref(p, 8bv64)]++(M[$add.ref(p, 7bv64)]++(M[$add.ref(p, 6bv64)]++(M[$add.ref(p, 5bv64)]++(M[$add.ref(p, 4bv64)]++(M[$add.ref(p, 3bv64)]++(M[$add.ref(p, 2bv64)]++(M[$add.ref(p, 1bv64)]++M[p]))))))))))))))))))) }
function {:inline} $store.bytes.bv160(M: [ref] bv8, p: ref, i: bv160) returns ([ref] bv8) { M[p := i[8:0]][$add.ref(p, 1bv64) := i[16:8]][$add.ref(p, 2bv64) := i[24:16]][$add.ref(p, 3bv64) := i[32:24]][$add.ref(p, 4bv64) := i[40:32]][$add.ref(p, 5bv64) := i[48:40]][$add.ref(p, 6bv64) := i[56:48]][$add.ref(p, 7bv64) := i[64:56]][$add.ref(p, 8bv64) := i[72:64]][$add.ref(p, 9bv64) := i[80:72]][$add.ref(p, 10bv64) := i[88:80]][$add.ref(p, 11bv64) := i[96:88]][$add.ref(p, 12bv64) := i[104:96]][$add.ref(p, 13bv64) := i[112:104]][$add.ref(p, 14bv64) := i[120:112]][$add.ref(p, 15bv64) := i[128:120]][$add.ref(p, 16bv64) := i[136:128]][$add.ref(p, 17bv64) := i[144:136]][$add.ref(p, 18bv64) := i[152:144]][$add.ref(p, 19bv64) := i[160:152]] }
...
function {:inline} $load.bytes.bv256(M: [ref] bv8, p: ref) returns (bv256) { (M[$add.ref(p, 31bv64)]++(M[$add.ref(p, 30bv64)]++(M[$add.ref(p, 29bv64)]++(M[$add.ref(p, 28bv64)]++(M[$add.ref(p, 27bv64)]++(M[$add.ref(p, 26bv64)]++(M[$add.ref(p, 25bv64)]++(M[$add.ref(p, 24bv64)]++(M[$add.ref(p, 23bv64)]++(M[$add.ref(p, 22bv64)]++(M[$add.ref(p, 21bv64)]++(M[$add.ref(p, 20bv64)]++(M[$add.ref(p, 19bv64)]++(M[$add.ref(p, 18bv64)]++(M[$add.ref(p, 17bv64)]++(M[$add.ref(p, 16bv64)]++(M[$add.ref(p, 15bv64)]++(M[$add.ref(p, 14bv64)]++(M[$add.ref(p, 13bv64)]++(M[$add.ref(p, 12bv64)]++(M[$add.ref(p, 11bv64)]++(M[$add.ref(p, 10bv64)]++(M[$add.ref(p, 9bv64)]++(M[$add.ref(p, 8bv64)]++(M[$add.ref(p, 7bv64)]++(M[$add.ref(p, 6bv64)]++(M[$add.ref(p, 5bv64)]++(M[$add.ref(p, 4bv64)]++(M[$add.ref(p, 3bv64)]++(M[$add.ref(p, 2bv64)]++(M[$add.ref(p, 1bv64)]++M[p]))))))))))))))))))))))))))))))) }
function {:inline} $store.bytes.bv256(M: [ref] bv8, p: ref, i: bv256) returns ([ref] bv8) { M[p := i[8:0]][$add.ref(p, 1bv64) := i[16:8]][$add.ref(p, 2bv64) := i[24:16]][$add.ref(p, 3bv64) := i[32:24]][$add.ref(p, 4bv64) := i[40:32]][$add.ref(p, 5bv64) := i[48:40]][$add.ref(p, 6bv64) := i[56:48]][$add.ref(p, 7bv64) := i[64:56]][$add.ref(p, 8bv64) := i[72:64]][$add.ref(p, 9bv64) := i[80:72]][$add.ref(p, 10bv64) := i[88:80]][$add.ref(p, 11bv64) := i[96:88]][$add.ref(p, 12bv64) := i[104:96]][$add.ref(p, 13bv64) := i[112:104]][$add.ref(p, 14bv64) := i[120:112]][$add.ref(p, 15bv64) := i[128:120]][$add.ref(p, 16bv64) := i[136:128]][$add.ref(p, 17bv64) := i[144:136]][$add.ref(p, 18bv64) := i[152:144]][$add.ref(p, 19bv64) := i[160:152]][$add.ref(p, 20bv64) := i[168:160]][$add.ref(p, 21bv64) := i[176:168]][$add.ref(p, 22bv64) := i[184:176]][$add.ref(p, 23bv64) := i[192:184]][$add.ref(p, 24bv64) := i[200:192]][$add.ref(p, 25bv64) := i[208:200]][$add.ref(p, 26bv64) := i[216:208]][$add.ref(p, 27bv64) := i[224:216]][$add.ref(p, 28bv64) := i[232:224]][$add.ref(p, 29bv64) := i[240:232]][$add.ref(p, 30bv64) := i[248:240]][$add.ref(p, 31bv64) := i[256:248]] }
...
axiom (__SMACK_code == $sub.ref(0bv64, 1032bv64));
procedure {:inline 1} __SMACK_code.ref($p0: ref);
procedure {:inline 1} __SMACK_code.ref.bv32($p0: ref, p.1: bv32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0bv64, 2064bv64));
procedure {:inline 1} __VERIFIER_assume($i0: bv32)
{
$bb0:
...
axiom (__SMACK_dummy == $sub.ref(0bv64, 3096bv64));
procedure {:inline 1} __SMACK_dummy($i0: bv32)
{
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1604, 29} true;
  assume {:verifier.code 1} true;
...
axiom (__SMACK_and32 == $sub.ref(0bv64, 4128bv64));
procedure {:inline 1} __SMACK_and32($i0: bv32, $i1: bv32)
  returns ($r: bv32)
{
  var $i2: bv32;
  var $i3: bv1;
...
axiom (__SMACK_and64 == $sub.ref(0bv64, 5160bv64));
procedure {:inline 1} __SMACK_and64($i0: bv64, $i1: bv64)
  returns ($r: bv64)
{
  var $i2: bv32;
  var $i3: bv32;
...
axiom (__SMACK_and16 == $sub.ref(0bv64, 6192bv64));
procedure {:inline 1} __SMACK_and16($i0: bv16, $i1: bv16)
  returns ($r: bv16)
{
  var $i2: bv32;
  var $i3: bv32;
...
axiom (__SMACK_and8 == $sub.ref(0bv64, 7224bv64));
procedure {:inline 1} __SMACK_and8($i0: bv8, $i1: bv8)
  returns ($r: bv8)
{
  var $i2: bv32;
  var $i3: bv32;
...
axiom (__SMACK_or32 == $sub.ref(0bv64, 8256bv64));
procedure {:inline 1} __SMACK_or32($i0: bv32, $i1: bv32)
  returns ($r: bv32)
{
  var $i2: bv32;
  var $i3: bv1;
...
axiom (__SMACK_or64 == $sub.ref(0bv64, 9288bv64));
procedure {:inline 1} __SMACK_or64($i0: bv64, $i1: bv64)
  returns ($r: bv64)
{
  var $i2: bv32;
  var $i3: bv32;
...
axiom (__SMACK_or16 == $sub.ref(0bv64, 10320bv64));
procedure {:inline 1} __SMACK_or16($i0: bv16, $i1: bv16)
  returns ($r: bv16)
{
  var $i2: bv32;
  var $i3: bv32;
...
axiom (__SMACK_or8 == $sub.ref(0bv64, 11352bv64));
procedure {:inline 1} __SMACK_or8($i0: bv8, $i1: bv8)
  returns ($r: bv8)
{
  var $i2: bv32;
  var $i3: bv32;
...
axiom (__SMACK_check_overflow == $sub.ref(0bv64, 12384bv64));
procedure {:inline 1} __SMACK_check_overflow($i0: bv32)
{
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1604, 29} true;
  assume {:verifier.code 1} true;
...
axiom (__SMACK_decls == $sub.ref(0bv64, 13416bv64));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0bv64, 14448bv64));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0bv64, 15480bv64));
...
axiom (llvm.dbg.value == $sub.ref(0bv64, 16512bv64));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0bv64, 17544bv64));
...
procedure {:inline 1} boogie_si_record_bv16(x: bv16);
procedure {:inline 1} boogie_si_record_bv32(x: bv32);
procedure {:inline 1} boogie_si_record_bv64(x: bv64);
procedure {:inline 1} boogie_si_record_bv8(x: bv8);
