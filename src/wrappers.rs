...
pub fn wasi_path_filestat_get(
    ...
    let host_pathname = ctx.translate_path(pathname, path_len, flags.should_follow(), fd);
    unwrap_result!(host_pathname);
...
pub fn wasi_path_link(
    ...
    let old_host_pathname = ctx.translate_path(old_pathname, old_path_len, true, old_fd);
    unwrap_result!(old_host_pathname);
    let new_host_pathname = ctx.translate_path(new_pathname, new_path_len, true, new_fd);
